...
public class VariablesOrder {
    ...
    public VariablesOrder(String firstName, String lastName, String address, String metroStation,
    ...
    public static VariablesOrder getVariablesParamOrder(List<String> color) {
        ...
        return new VariablesOrder(firstName, lastName, address, metroStation, phone, renTime, deliveryDate, comment, color);
    }

    @Step("Getting all variables for creating a order")
    public static VariablesOrder getVariablesOrder() {
        // динамические переменные для теста
        String firstName = RandomStringUtils.randomAlphabetic(10); //имя
        String lastName = RandomStringUtils.randomAlphabetic(10); // фамилия
        String address = RandomStringUtils.randomAlphabetic(15); // адрес
